    		...
    		<div class="col-sm-6">
  				...
  				<table class="table table-bordered table-striped">
    				<tbody>
						...
						<tr>
							<td><p class="text-right">Commanded</p></td>
							<td><Strong><span class="badge">${fn:length(rescuer.operationDetails)}</span> </Strong>
							
							<c:url var="commandedLink" value="/rescuer/commanded">
							<c:param name="rescuerId" value="${rescuer.id}" />
							</c:url>
							<button type="button" class="btn btn-sm btn-success active" onclick="location.href='${commandedLink}'">Show</button>
    						</td>
						</tr>
						<tr>
